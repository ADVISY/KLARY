...
FROM afa_themes t
WHERE t.filiere_key = 'vie' AND t.key = 'retraite_obligatoire'
ON CONFLICT (external_id) DO NOTHING;
...
FROM afa_themes t
WHERE t.filiere_key = 'vie' AND t.key = 'retraite_individuelle'
ON CONFLICT (external_id) DO NOTHING;
