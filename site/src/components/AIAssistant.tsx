          ...
          <div className="bg-gradient-to-r from-[#1800AD] to-[#2800CD] text-white p-4 flex items-center justify-between rounded-t-3xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/80">Assistante Klary</p>
              </div>
            </div>
            <Button
              variant="ghost"
              ...
              <div className="flex flex-col items-center justify-center p-6 text-center">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    L'assistante Klary spécialisée en assurances suisses
                  </p>
                </div>
