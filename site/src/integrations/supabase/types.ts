  ...
  public: {
    Tables: {
      ...
      recruitment_applications: {
        Row: {
          address: string | null
          afa_up_to_date: boolean | null
          availability: string | null
          birth_date: string | null
          canton: string | null
          cantons_covered: string[] | null
          city: string | null
          civil_status: string | null
          consent_given: boolean
          created_at: string
          criminal_record_clean: boolean | null
          current_employer: string | null
          debt_record_clean: boolean | null
          documents: Json | null
          driving_license: boolean | null
          email: string
          finma_number: string | null
          finma_status: string | null
          first_name: string
          has_vehicle: boolean | null
          highest_diploma: string | null
          id: string
          languages: Json | null
          last_name: string
          message: string | null
