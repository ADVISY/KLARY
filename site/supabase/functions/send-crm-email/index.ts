...
<body>
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <!-- Signature & Footer -->
      <div class="footer">
        <div class="logo-text" style="font-size: 24px; color: #1800AD; margin-bottom: 12px;">klary<span class="logo-dot">.</span></div>
        <p class="footer-text">
          <strong>Klary Sàrl</strong><br>
        ...
        <div class="footer-links">
          <a href="https://klary.ch" class="footer-link">www.klary.ch</a>
          <span class="footer-divider">|</span>
          <a href="mailto:info@klary.ch" class="footer-link">info@klary.ch</a>
        </div>
        <p class="footer-text" style="margin-top: 24px; font-size: 11px; color: #9ca3af;">
          ...
          © ${new Date().getFullYear()} Klary Sàrl. Tous droits réservés.
        </p>
      </div>
    </div>
  </div>
...
const getEmailContent = (type: string, clientName: string, data?: EmailData) => {
  switch (type) {
    case "welcome":
      return {
        subject: "🎉 Bienvenue chez Klary - Votre partenaire assurance",
        html: getEmailWrapper(`
          <div class="header">
            <div class="logo-container">
              <div class="logo-text">klary<span class="logo-dot">.</span></div>
            </div>
            <h1 class="header-title">Bienvenue chez Klary !</h1>
          ...
          <div class="content">
            ...
            <div class="highlight-box">
              <strong>Votre conseiller Klary</strong> est désormais à votre disposition pour vous accompagner dans toutes vos démarches d'assurance en Suisse.
            </div>
            <p class="text">Chez Klary, nous nous engageons à :</p>
            ...
            <div class="signature">
              ...
              <p class="signature-name">L'équipe Klary</p>
            </div>
          </div>
        `),
      };
    ...
    case "contract_signed":
      return {
        subject: "✅ Confirmation de signature - Votre contrat Klary",
        html: getEmailWrapper(`
          <div class="header">
            <div class="logo-container">
              <div class="logo-text">klary<span class="logo-dot">.</span></div>
    ...
    case "mandat_signed":
      return {
        subject: "🔐 Votre espace client Klary est prêt !",
        html: getEmailWrapper(`
          <div class="header">
            <div class="logo-container">
              <div class="logo-text">klary<span class="logo-dot">.</span></div>
          ...
          <div class="content">
            ...
            <div class="success-box">
              ...
              Klary est désormais mandaté pour gérer et optimiser votre portefeuille d'assurances.
            </div>
            ...
            <div class="cta-container">
              <a href="${data?.loginUrl || 'https://klary.ch/connexion'}" class="cta-button">
    ...
    case "account_created":
      return {
        subject: "🔑 Votre compte Klary a été créé",
        html: getEmailWrapper(`
          <div class="header">
            <div class="logo-container">
              <div class="logo-text">klary<span class="logo-dot">.</span></div>
          ...
          <div class="content">
            <p class="greeting">Bonjour ${clientName} 👋</p>
            <p class="text">
              Votre compte client Klary a été créé avec succès. Vous pouvez maintenant accéder à votre espace personnel pour gérer vos assurances.
            </p>
            <div class="credentials-box">
              <h3 class="credentials-title">🔐 Vos identifiants de connexion</h3>
              <p class="credential-label">Adresse email</p>
    ...
    case "relation_client":
      return {
        subject: "💬 Votre conseiller Klary prend de vos nouvelles",
        html: getEmailWrapper(`
          <div class="header">
            <div class="logo-container">
              <div class="logo-text">klary<span class="logo-dot">.</span></div>
            ...
            <p class="header-subtitle">Votre conseiller Klary pense à vous</p>
          </div>
          <div class="content">
            <p class="greeting">Bonjour ${clientName} 👋</p>
            <p class="text">
            ...
            <div class="cta-container">
              <a href="https://klary.ch" class="cta-button">
                Prendre rendez-vous →
              </a>
            </div>
            <p class="text" style="text-align: center; color: #6b7280; font-size: 14px;">
      ...
      return {
        ...
        html: getEmailWrapper(`
          ...
          <div class="content">
            ...
            <div class="cta-container">
              <a href="https://klary.ch" class="cta-button" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);">
    ...
    default:
      return {
        ...
        html: getEmailWrapper(`
          ...
          <div class="content">
            <p class="greeting">Bonjour ${clientName},</p>
            <p class="text">Vous avez une nouvelle notification d'Klary.</p>
            <div class="signature">
              <p class="signature-text">Cordialement,</p>
              <p class="signature-name">L'équipe Klary</p>
            </div>
    ...
    if (type === "mandat_signed" && !data?.temporaryPassword) {
      ...
      if (!existingUser) {
        ...
        emailData = {
          ...
          temporaryPassword,
          clientEmail,
          loginUrl: `${Deno.env.get("SITE_URL") || "https://klary.ch"}/connexion`,
        };
